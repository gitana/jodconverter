...
//      logger.info(String.format("successful conversion: %s [%db] to %s in %dms", inputExtension, inputFile.length(),
//          outputExtension, conversionTime));
      LOG.info("successful conversion: {} [{} bytes] to {} in {} ms", 
          inputExtension, inputFile.length(), outputExtension, conversionTime);
...
//          inputFile.length(), outputExtension, exception, inputFile.getName()));
      LOG.error("failed conversion: {} [{} bytes] to {}; {}; input file: {}", 
